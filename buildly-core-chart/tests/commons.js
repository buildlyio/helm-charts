const bifrostHost = 'define.bifrost.host.com';
    ...
    base: {
      ...
      env: [
        ...
        },
        {
          ...
          "value": "http://RELEASE-NAME-bifrost-elasticsearch:9200/"
        },
        {
        ...
        },
        {
          ...
          "value": `https://${bifrostHost}/complete/microsoft-graph`
        },
        {
        ...
        {
          "name": "DATABASE_HOST",
          "value": "RELEASE-NAME-bifrost-postgres"
        },
        {
          "name": "DATABASE_NAME",
          "value": "bifrost"
